...
const FEATURED_PHOTOS = [
  ...
  // Families
  { id: 11, url: '/family-1.png', alt: 'Extended family portrait in field - Family photography Alabama', category: 'family' },
  { id: 12, url: '/family-2.png', alt: 'Father and baby - Newborn family photography', category: 'family' },
  { id: 13, url: '/family-3.png', alt: 'Mother daughter portrait - Family session North Alabama', category: 'family' },
];
  ...
  return (
    <>
      <SEO 
        ...
        url="/featured"
        keywords="wedding photography portfolio, Alabama wedding photos, North Alabama photographer gallery"
      />
      ...
      <main className="pt-20 md:pt-24">
        ...
        <section className="relative h-[50vh] min-h-[400px] bg-charcoal flex items-center justify-center overflow-hidden">
          <img 
            ...
            alt="Wedding photography - North Alabama wedding photographer"
